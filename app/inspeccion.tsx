...
// ─── Mini gráfico (sidebar historial) ─────────────────────────────────────
const MINI_W = 220;
const MINI_H = 48;
...
export default function PantallaELD() {
  ...
  const cargarTodoElELD = async () => {
    ...
    try {
      ...
      const jornada: any = await db.getFirstAsync(
      ...
      console.log('Error ELD:', e);
    } finally {
      setCargando(false);
    }
  };

  // ─── Carga historial: hoy + 4 días anteriores ─────────────────────────────
            ...
            <View style={styles.footer}>
              ...
              <View style={styles.qrCard}>
                ...
                <View style={{ flex: 1, marginLeft: 15 }}>
                  ...
                  {/* ✅ Vuelve a jornadaEnCurso sin resetear el stack */}
